...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    /**
     * The deferred Service and their providers.
     *
     * @var array
     */
    ...
    public function loadDeferredProviders()
    {
        ...
        // the remaining Service available to this application for immediate use.
    ...
    public function loadDeferredProvider($service)
    {
        ...
        // of deferred Service, since it will already be loaded on subsequent.
    ...
    public function registerDeferredProvider($provider, $service = null)
    {
        ...
        // will remove it from our local list of the deferred Service with related
    ...
    {
        return $this->bootstrapPath().'/cache/Service.php';
    }
