...
class TransportManager extends Manager
{
    ...
    {
        $config = $this->app['config']->get('Service.ses', []);
    ...
    {
        $config = $this->app['config']->get('Service.mailgun', []);
    ...
    {
        $config = $this->app['config']->get('Service.mandrill', []);
    ...
    {
        $config = $this->app['config']->get('Service.sparkpost', []);
