...
class Container implements ArrayAccess, ContainerContract
{
    ...
    /**
     * The extension closures for Service.
     *
     * @var array
     */
    protected $extenders = [];
    ...
    public function make($abstract, array $parameters = [])
    {
        ...
        // of Service, such as changing configuration or decorating the object.
    ...
    /**
     * Dynamically access container Service.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    /**
     * Dynamically set container Service.
     *
     * @param  string  $key
     * @param  mixed   $value
     * @return void
