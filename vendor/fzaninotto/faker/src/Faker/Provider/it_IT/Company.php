...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $bsWords = array(
        array(
            'partnerships', 'comunità', 'ROI', 'soluzioni', 'e-Service', 'nicchie', 'tecnologie', 'contenuti', 'supply-chains', 'convergenze', 'relazioni', 'architetture', 'interfacce', 'mercati', 'e-commerce', 'sistemi', 'modelli', 'schemi', 'reti', 'applicazioni', 'metriche', 'e-business', 'funzionalità', 'esperienze', 'webservices', 'metodologie'
        ),
        array(
